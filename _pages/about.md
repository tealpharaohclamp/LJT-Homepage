...
* **Research Intern**, Tencent WXG (June 2024 – September 2024) — supervised by Zifei Shan
* **Research Intern**, Shanghai AI Lab (June 2023 – December 2023) — supervised by Prof. Yu Cheng
...
* LLM Reasoning and Reinforcement Learning
* Hallucination Analysis in Vision-Language Models (VLM)
* LLM Truthfulness and Interpretability
* Reasoning Data Synthesis and Evaluation-Suite Construction
* Scientific Writing and Open-Source Research (arXiv preprints and code releases)
